<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Curs09.aspx.cs" Inherits="MPPWeb.Curs09" %>
...
<body>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ...
        style="position: absolute; top: 67px; left: 296px; width: 124px;">&nbsp;</asp:RequiredFieldValidator>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
        ...
        ControlToValidate="TxtPretVanzare" SetFocusOnError="True">&nbsp;</asp:RequiredFieldValidator>
    ...
    <asp:DropDownList ID="DdlUM" runat="server" 
        style="position: absolute; top: 172px; left: 139px;">
    ...
    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
        ErrorMessage="Data eronata" 
        style="position: absolute; top: 275px; left: 314px; width: 121px;" 
    ...
    <asp:Label ID="Label3" runat="server" Text="AM RAMAS LA PCTU 4"></asp:Label>
